...
public class Replyfordocumentwithdropdown {
	...
	static public void starttest() {
		...
		HtmlReporter = new ExtentHtmlReporter("replyfordocument.html");
	...
	public void test01() throws InterruptedException, AWTException {
		...
		ac.moveToElement(e).perform();
		Thread.sleep(3000);
		WebElement e1=driver.findElement(By.xpath("(//div[@class='conversation-option-wrapper'])[2]"));
		ac.click(e1).build().perform();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[@class='conversation-reply-button conversation-option'])[2]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@class='message-input']")).sendKeys("test");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//span[@id='sendMessageBtn']")).click();
	...
	public void test02() throws InterruptedException, AWTException {
		...
		ac.moveToElement(e).perform();
		Thread.sleep(3000);
		WebElement e1=driver.findElement(By.xpath("(//div[@class='conversation-option-wrapper'])[3]"));
		ac.click(e1).build().perform();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[@class='conversation-reply-button conversation-option'])[3]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@class='message-input']")).sendKeys("test");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//span[@id='sendMessageBtn']")).click();
	...
	public void test03() throws InterruptedException, AWTException {
		...
		ac.moveToElement(e).perform();
		Thread.sleep(3000);
		WebElement e1=driver.findElement(By.xpath("(//div[@class='conversation-option-wrapper'])[4]"));
		ac.click(e1).build().perform();
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//div[@class='conversation-reply-button conversation-option'])[4]")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@class='message-input']")).sendKeys("test");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//span[@id='sendMessageBtn']")).click();
