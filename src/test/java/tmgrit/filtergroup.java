...
public class filtergroup {
	...
	static public void starttest() {
		...
		HtmlReporter = new ExtentHtmlReporter("inputfiltergroupgrit2.html");
	...
	public void test00() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("0.Click on filter in group");
		...
		test.info("EXPECTED RESULT ::  It should click on filter in group ");		
		...
		test.log(Status.PASS ,"ACTUAL RESULT ::  It is clicking on filter in group ");
	...
	public void test01() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("1.Click on filter image in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test04() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("4.Click on filter video in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test07() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("7.Click on filter doc in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test10() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("10.Click on filter link in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test13() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("13.Click on filter contact in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test16() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("16.Click on filter location in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test19() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("19.Click on filter read receipt in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test22() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-image']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("22.Click on filter image in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test25() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-video']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("25.Click on filter video in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test28() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-doc']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("28.Click on filter doc in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test32() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-link']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("32.Click on filter link in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test35() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-contact']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("35.Click on filter contact in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test38() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-location']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("38.Click on filter location in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test41() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='filter-icon filter-icon-read-receipt']")).click();
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("41.Click on filter Read Receipt in group");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
