...
public class inputsearchuser {
	...
	static public void starttest() {
		...
		HtmlReporter = new ExtentHtmlReporter("inputsearchusergrit2.html");
	...
	public void test00() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("0.Click on search in user");
	...
	public void test06() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("6.Select the user whose didn't send msg in user");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
	...
	public void test07() throws InterruptedException {
		...
		Thread.sleep(1000);
		ExtentTest test=extent.createTest("7.Select user in All users list");
		test.log(Status.INFO, "Desktop application launching Successfully");
		test.info("Navigate to server url ");
		test.info("Enter server url : http://192.168.2.55:8083");
		test.info("Click on submit");
